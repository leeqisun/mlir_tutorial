// RUN: ns-opt %s --convert-north-satr-to-linalg --outline-north-star-device-kernels --lower-north-star-device-kernels-to-loops --lower-north-star-host-to-npu-calls --lower-north-star-npu-calls-to-runtime --lower-north-star-runtime-stubs-to-h350-calls --generate-north-star-runtime-json --split-input-file | FileCheck %s
module @NorthStar {
  // CHECK: north_star.runtime_json = "{
  // CHECK-SAME: \22c_api\22: \22north_star_h350_launch_f32\22
  ...
  // CHECK: \22target\22: \22amd_h350_npu\22
